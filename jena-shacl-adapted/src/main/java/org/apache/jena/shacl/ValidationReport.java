...
public class ValidationReport {
    ...
    private int numberOfValidatedConstraints = 0;
    ...
    private ValidationReport(Set<Triple> paths, Collection<ReportEntry> entries, PrefixMapping prefixes, int numberOfValidatedConstraints) {
        this(entries, generate(paths, entries, prefixes));
        this.numberOfValidatedConstraints = numberOfValidatedConstraints;
    }
    ...
    public static class Builder {
        ...
        public ValidationReport build() {
            return new ValidationReport(paths, entries, prefixes,numberOfValidatedConstraints);
        }


        public void incrementNumberOfValidatedConstraints() {
            numberOfValidatedConstraints++;
        }

        public int getNumberOfValidatedConstraints() {
            return numberOfValidatedConstraints;
        }
    }
